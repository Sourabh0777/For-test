...
import RadioButtonsGroup from "components/RadioButton/Index";
...
function Form() {
  ...
  const radioButtonHandler = (event) => {
    setRadioButtonValue(event.target.value); // Update the state in the parent component
  };
  console.log("🚀 ~ file: index.js:49 ~ Form ~ radioButtonValue:", radioButtonValue);
              ...
              >
                <Grid container spacing={3}>
                  <Grid item xs={12} md={12}>
                    <RadioButtonsGroup onChange={radioButtonHandler} />
                  </Grid>
