...
function BusForm() {
  ...
  // const [selectedAc, setSelectedAc] = useState("nonAc");
  // const [selectedSeater, setSelectedSeater] = useState();
  console.log("🚀 ~ file: index.js:48 ~ Form ~ userName:", userName);
  console.log("🚀 ~ file: index.js:49 ~ Form ~ mobileNo:", mobileNo);
  console.log("🚀 ~ file: index.js:52 ~ Form ~ dateOfTraveling:", dateOfTraveling);
  console.log("🚀 ~ file: index.js:51 ~ Form ~ departureTime:", formatTime(departureTime));
  console.log("🚀 ~ file: index.js:61 ~ Form ~ destinationFrom:", destinationFrom);
  console.log("🚀 ~ file: index.js:62 ~ Form ~ destinationTo:", destinationTo);
  console.log("🚀 ~ file: index.js:63 ~ Form ~ noOfPassengers:", noOfPassengers);
  // console.log("🚀 ~ file: index.js:65 ~ Form ~ selectedSeater:", selectedAc);
  // console.log("🚀 ~ file: index.js:66 ~ Form ~ selectedSeater:", selectedSeater);
